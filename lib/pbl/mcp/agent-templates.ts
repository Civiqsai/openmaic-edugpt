...
export function getQuestionAgentPrompt(_language: string = 'en-US'): string {
  // All languages use the English template (LLM prompts work fine in English)
...
// Chinese prompt constants removed — all languages now use the English templates above.
