...
Format your response as a numbered list.`;
    ...
    // User-facing welcome message: Dutch for nl-NL, English otherwise
    ...
    const welcomeMessage = isNL
        ? `Hallo! Ik ben je Vraagassistent voor deze opdracht: "${firstIssue.title}"\n\nOm je op weg te helpen heb ik een aantal vragen voorbereid:\n\n${generatedQuestions}\n\nJe kunt me altijd bereiken via @question als je hulp of verduidelijking nodig hebt!`
