...
export interface UserRequirements {
  ...
  language: 'zh-CN' | 'en-US' | 'nl-NL'; // Course language - critical for generation
...
export interface SceneOutline {
  ...
  order: number;
  language?: 'zh-CN' | 'en-US' | 'nl-NL'; // Generation language (inherited from requirements)
