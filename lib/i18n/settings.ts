...
export const settingsNlNL = {
  settings: {
    title: 'Instellingen',
    description: 'Applicatie-instellingen configureren',
    language: 'Taal',
    languageDesc: 'Kies de interfacetaal',
    theme: 'Thema',
    themeDesc: 'Kies een thema (Licht/Donker/Systeem)',
    themeOptions: {
      light: 'Licht',
      dark: 'Donker',
      system: 'Systeem',
    ...
    apiKey: 'API-sleutel',
    apiKeyDesc: 'Configureer je API-sleutel',
    apiBaseUrl: 'API-eindpunt URL',
    apiBaseUrlDesc: 'Configureer je API-eindpunt URL',
    apiKeyRequired: 'API-sleutel mag niet leeg zijn',
    model: 'Modelconfiguratie',
    modelDesc: 'Configureer AI-modellen',
    modelPlaceholder: 'Voer modelnaam in of selecteer er een',
    ttsModel: 'TTS-model',
    ttsModelDesc: 'Configureer TTS-modellen',
    ttsModelPlaceholder: 'Voer TTS-modelnaam in of selecteer er een',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    testConnection: 'Verbinding testen',
    testConnectionDesc: 'Test of de huidige API-configuratie werkt',
    testing: 'Testen...',
    agentSettings: 'Agent-instellingen',
    agentSettingsDesc:
      'Selecteer de agents die deelnemen aan het gesprek. Selecteer 1 voor enkelvoudige agentmodus, selecteer meerdere voor samenwerkingsmodus.',
    agentMode: 'Agentmodus',
    agentModePreset: 'Voorinstelling',
    agentModeAuto: 'Automatisch genereren',
    agentModeAutoDesc: 'AI genereert automatisch passende rollen',
    autoAgentCount: 'Aantal agents',
    autoAgentCountDesc: 'Aantal automatisch te genereren agents (inclusief docent)',
    atLeastOneAgent: 'Selecteer minstens 1 agent',
    singleAgentMode: 'Enkelvoudige agentmodus',
    directAnswer: 'Direct antwoord',
    multiAgentMode: 'Multi-agentmodus',
    agentsCollaborating: 'Samenwerkingsdiscussie',
    agentsCollaboratingCount: '{count} agents geselecteerd voor samenwerkingsdiscussie',
    maxTurns: 'Maximaal aantal discussierondes',
    maxTurnsDesc:
      'Het maximale aantal discussierondes tussen agents (elke agent die acties voltooit en antwoordt telt als een ronde)',
    priority: 'Prioriteit',
    actions: 'Acties',
    actionCount: '{count} acties',
    selectedAgent: 'Geselecteerde agent',
    selectedAgents: 'Geselecteerde agents',
    required: 'Vereist',
    agentNames: {
      'default-1': 'AI-docent',
      'default-2': 'AI-assistent',
      'default-3': 'Klassenclown',
      'default-4': 'Nieuwsgierige geest',
      'default-5': 'Notulist',
      'default-6': 'Diepdenker',
    },
    agentRoles: {
      teacher: 'Docent',
      assistant: 'Assistent',
    ...
    agentDescriptions: {
      'default-1': 'Hoofddocent met heldere en gestructureerde uitleg',
      'default-2': 'Ondersteunt het leren en verduidelijkt kernpunten',
      'default-3': 'Brengt humor en energie in het klaslokaal',
      'default-4': 'Altijd nieuwsgierig, stelt graag waarom- en hoe-vragen',
      'default-5': 'Maakt zorgvuldig notities en organiseert lesaantekeningen',
      'default-6': 'Denkt diep na en onderzoekt de kern van onderwerpen',
    },
    close: 'Sluiten',
    save: 'Opslaan',
    // Provider settings
    providers: 'LLM',
    addProviderDescription: 'Voeg aangepaste modelproviders toe om beschikbare AI-modellen uit te breiden',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    conversationSettings: 'Gesprek',
    keyboardShortcuts: 'Sneltoetsen',
    generalSettings: 'Algemeen',
    systemSettings: 'Systeem',
    addProvider: 'Toevoegen',
    importFromClipboard: 'Importeren uit klembord',
    apiSecret: 'API-sleutel',
    apiHost: 'Base URL',
    requestUrl: 'Verzoek-URL',
    models: 'Modellen',
    addModel: 'Nieuw',
    reset: 'Resetten',
    fetch: 'Ophalen',
    ...
    // Provider management
    addProviderButton: 'Toevoegen',
    addProviderDialog: 'Modelprovider toevoegen',
    providerName: 'Naam',
    providerNamePlaceholder: 'bijv. Mijn OpenAI-proxy',
    providerNameRequired: 'Voer een providernaam in',
    providerApiMode: 'API-modus',
    apiModeOpenAI: 'OpenAI-protocol',
    apiModeAnthropic: 'Claude-protocol',
    apiModeGoogle: 'Gemini-protocol',
    defaultBaseUrl: 'Standaard Base URL',
    providerIcon: 'Provider-pictogram URL',
    requiresApiKey: 'API-sleutel vereist',
    deleteProvider: 'Provider verwijderen',
    deleteProviderConfirm: 'Weet je zeker dat je deze provider wilt verwijderen?',
    cannotDeleteBuiltIn: 'Kan ingebouwde provider niet verwijderen',
    resetToDefault: 'Standaardinstellingen herstellen',
    resetToDefaultDescription:
      'Modellijst herstellen naar standaardconfiguratie (API-sleutel en Base URL blijven behouden)',
    resetConfirmDescription:
      'Dit verwijdert alle aangepaste modellen en herstelt de ingebouwde standaardmodellijst. API-sleutel en Base URL blijven behouden.',
    confirmReset: 'Reset bevestigen',
    resetSuccess: 'Succesvol hersteld naar standaardconfiguratie',
    saveSuccess: 'Instellingen opgeslagen',
    saveFailed: 'Opslaan mislukt, probeer het opnieuw',
    cannotDeleteBuiltInModel: 'Kan ingebouwd model niet verwijderen',
    cannotEditBuiltInModel: 'Kan ingebouwd model niet bewerken',
    modelIdRequired: 'Voer een model-ID in',
    noModelsAvailable: 'Geen modellen beschikbaar voor testen',
    providerMetadata: 'Provider-metadata',
    // Model editing
    editModel: 'Model bewerken',
    editModelDescription: 'Modelconfiguratie en mogelijkheden bewerken',
    addNewModel: 'Nieuw model',
    addNewModelDescription: 'Een nieuwe modelconfiguratie toevoegen',
    modelId: 'Model-ID',
    modelIdPlaceholder: 'bijv. gpt-4o',
    modelName: 'Weergavenaam',
    modelNamePlaceholder: 'Optioneel',
    modelCapabilities: 'Mogelijkheden',
    advancedSettings: 'Geavanceerde instellingen',
    contextWindowLabel: 'Contextvenster',
    contextWindowPlaceholder: 'bijv. 128000',
    outputWindowLabel: 'Max. uitvoertokens',
    outputWindowPlaceholder: 'bijv. 4096',
    testModel: 'Model testen',
    deleteModel: 'Verwijderen',
    cancelEdit: 'Annuleren',
    saveModel: 'Opslaan',
    modelsManagementDescription:
      'Beheer modellen voor deze provider. Ga naar "Algemeen" om het actieve model te selecteren.',
    // General settings
    howToUse: 'Gebruiksaanwijzing',
    step1ConfigureProvider:
      'Ga naar "Modelproviders", selecteer of voeg een provider toe en configureer de verbindingsinstellingen (API-sleutel, Base URL, etc.)',
    step2SelectModel: 'Selecteer het model dat je wilt gebruiken bij "Actief model" hieronder',
    step3StartUsing: 'Na het opslaan gebruikt het systeem het door jou gekozen model',
    activeModel: 'Actief model',
    activeModelDescription: 'Selecteer het model voor AI-gesprekken en inhoudsgeneratie',
    selectModel: 'Model selecteren',
    searchModels: 'Modellen zoeken',
    noModelsFound: 'Geen overeenkomende modellen gevonden',
    noConfiguredProviders: 'Geen geconfigureerde providers',
    configureProvidersFirst:
      'Configureer eerst de providerverbinding bij "Modelproviders" aan de linkerkant',
    currentlyUsing: 'Momenteel in gebruik',
    // TTS settings
    ttsSettings: 'Spraaksynthese',
    // ASR settings
    asrSettings: 'Spraakherkenning',
    // Audio settings (legacy)
    audioSettings: 'Audio-instellingen',
    ttsSection: 'Tekst-naar-spraak (TTS)',
    asrSection: 'Automatische spraakherkenning (ASR)',
    ttsDescription: 'TTS (Text-to-Speech) - Zet tekst om in spraak',
    asrDescription: 'ASR (Automatic Speech Recognition) - Zet spraak om in tekst',
    enableTTS: 'Spraaksynthese inschakelen',
    ttsEnabledDescription: 'Indien ingeschakeld wordt er spraak gegenereerd bij het aanmaken van lessen',
    enableASR: 'Spraakherkenning inschakelen',
    asrEnabledDescription: 'Indien ingeschakeld kunnen studenten de microfoon gebruiken voor spraakinvoer',
    ttsProvider: 'TTS-provider',
    ttsLanguageFilter: 'Taalfilter',
    allLanguages: 'Alle talen',
    ttsVoice: 'Stem',
    ttsSpeed: 'Snelheid',
    ttsBaseUrl: 'Base URL',
    ttsApiKey: 'API-sleutel',
    asrProvider: 'ASR-provider',
    asrLanguage: 'Herkenningstaal',
    asrBaseUrl: 'Base URL',
    asrApiKey: 'API-sleutel',
    enterApiKey: 'Voer API-sleutel in',
    enterCustomBaseUrl: 'Voer aangepaste Base URL in',
    browserNativeNote: 'Browser-native ASR vereist geen configuratie en is volledig gratis',
    // Audio provider names
    providerOpenAITTS: 'OpenAI TTS (gpt-4o-mini-tts)',
    providerAzureTTS: 'Azure TTS',
    providerGLMTTS: 'GLM TTS',
    ...
    providerUnpdf: 'unpdf (ingebouwd)',
    providerMinerU: 'MinerU',
    browserNativeTTSNote:
      'Browser-native TTS vereist geen configuratie en is volledig gratis, gebruikt ingebouwde systeemstemen',
    testTTS: 'TTS testen',
    testASR: 'ASR testen',
    testSuccess: 'Test geslaagd',
    testFailed: 'Test mislukt',
    ttsTestText: 'TTS-testtekst',
    ttsTestSuccess: 'TTS-test geslaagd, audio afgespeeld',
    ttsTestFailed: 'TTS-test mislukt',
    asrTestSuccess: 'Spraakherkenning geslaagd',
    asrTestFailed: 'Spraakherkenning mislukt',
    asrResult: 'Herkenningsresultaat',
    asrNotSupported: 'Browser ondersteunt de Speech Recognition API niet',
    browserTTSNotSupported: 'Browser ondersteunt de Speech Synthesis API niet',
    browserTTSNoVoices: 'Huidige browser heeft geen beschikbare TTS-stemmen',
    microphoneAccessDenied: 'Microfoontoegang geweigerd',
    microphoneAccessFailed: 'Kan geen toegang krijgen tot de microfoon',
    asrResultPlaceholder: 'Herkenningsresultaat wordt weergegeven na opname',
    useThisProvider: 'Deze provider gebruiken',
    fetchVoices: 'Stemmenlijst ophalen',
    fetchingVoices: 'Ophalen...',
    voicesFetched: 'Stemmen opgehaald',
    fetchVoicesFailed: 'Stemmen ophalen mislukt',
    voiceApiKeyRequired: 'API-sleutel vereist',
    voiceBaseUrlRequired: 'Base URL vereist',
    ttsTestTextPlaceholder: 'Voer tekst in om te converteren',
    ttsTestTextDefault: 'Hallo, dit is een teststem.',
    startRecording: 'Opname starten',
    stopRecording: 'Opname stoppen',
    recording: 'Opnemen...',
    transcribing: 'Transcriberen...',
    transcriptionResult: 'Transcriptieresultaat',
    noTranscriptionResult: 'Geen transcriptieresultaat',
    baseUrlOptional: 'Base URL (optioneel)',
    defaultValue: 'Standaard',
    // TTS Voice descriptions (OpenAI)
    voiceMarin: 'Aanbevolen - Beste kwaliteit',
    voiceCedar: 'Aanbevolen - Beste kwaliteit',
    voiceAlloy: 'Neutraal, gebalanceerd',
    voiceAsh: 'Rustig, professioneel',
    voiceBallad: 'Elegant, lyrisch',
    voiceCoral: 'Warm, vriendelijk',
    voiceEcho: 'Mannelijk, helder',
    voiceFable: 'Verhalend, levendig',
    voiceNova: 'Vrouwelijk, helder',
    voiceOnyx: 'Mannelijk, diep',
    voiceSage: 'Wijs, beheerst',
    voiceShimmer: 'Vrouwelijk, zacht',
    voiceVerse: 'Natuurlijk, vloeiend',
    // TTS Voice descriptions (GLM)
    glmVoiceTongtong: 'Standaardstem',
    glmVoiceChuichui: 'Chuichui-stem',
    glmVoiceXiaochen: 'Xiaochen-stem',
    glmVoiceJam: 'Jam-stem',
    glmVoiceKazi: 'Kazi-stem',
    glmVoiceDouji: 'Douji-stem',
    glmVoiceLuodo: 'Luodo-stem',
    // TTS Voice descriptions (Qwen)
    qwenVoiceCherry: 'Zonnig, warm en natuurlijk',
    qwenVoiceSerena: 'Zacht en teder',
    qwenVoiceEthan: 'Energiek en levendig',
    qwenVoiceChelsie: 'Anime virtuele vriendin',
    qwenVoiceMomo: 'Speels en vrolijk',
    qwenVoiceVivian: 'Schattig en brutaal',
    qwenVoiceMoon: 'Cool en stoer',
    qwenVoiceMaia: 'Intellectueel en zachtaardig',
    qwenVoiceKai: 'Een spa voor je oren',
    qwenVoiceNofish: 'Ontwerper met een unieke uitspraak',
    qwenVoiceBella: 'Schattig meisje dat niet dronken wordt',
    qwenVoiceJennifer: 'Professionele, filmische Amerikaanse vrouwenstem',
    qwenVoiceRyan: 'Snel tempo, dramatische performance',
    qwenVoiceKaterina: 'Volwassen dame met gedenkwaardig ritme',
    qwenVoiceAiden: 'Amerikaanse jongen die kan koken',
    qwenVoiceEldricSage: 'Rustige en wijze oudere',
    qwenVoiceMia: 'Zacht als lentewater, braaf als sneeuw',
    qwenVoiceMochi: 'Slim kind met kinderlijke onschuld',
    qwenVoiceBellona: 'Luide stem, duidelijke uitspraak, levendige personages',
    qwenVoiceVincent: 'Unieke hese stem vol verhalen over oorlog en eer',
    qwenVoiceBunny: 'Superschattige loli',
    qwenVoiceNeil: 'Professionele nieuwslezer',
    qwenVoiceElias: 'Professionele docent',
    qwenVoiceArthur: 'Eenvoudige stem gerijpt door de jaren',
    qwenVoiceNini: 'Zachte en plakkerige stem als mochi',
    qwenVoiceEbona: 'Haar fluistering is als een roestige sleutel',
    qwenVoiceSeren: 'Zachte en rustgevende stem om in slaap te vallen',
    qwenVoicePip: 'Ondeugend maar vol kinderlijke onschuld',
    qwenVoiceStella: 'Zoete verwarde meisjesstem die vastberaden wordt wanneer het moet',
    qwenVoiceBodega: 'Enthousiaste Spaanse oom',
    qwenVoiceSonrisa: 'Enthousiaste Latijns-Amerikaanse dame',
    qwenVoiceAlek: 'Koude van het noorden, warmte onder de wollen jas',
    qwenVoiceDolce: 'Luie Italiaanse oom',
    qwenVoiceSohee: 'Zachte, vrolijke Koreaanse zus',
    qwenVoiceOnoAnna: 'Ondeugende jeugdvriendin',
    qwenVoiceLenn: 'Rationele Duitse jongeman die pak draagt en naar post-punk luistert',
    qwenVoiceEmilien: 'Romantische Franse grote broer',
    qwenVoiceAndre: 'Magnetische, natuurlijke en kalme mannenstem',
    qwenVoiceRadioGol: 'Voetbaldichter Rádio Gol!',
    qwenVoiceJada: 'Levendige Shanghai-dame',
    qwenVoiceDylan: 'Jongen uit Beijing',
    qwenVoiceLi: 'Geduldige yogadocent',
    qwenVoiceMarcus: 'Breed gezicht, weinig woorden, solide hart - oude Shaanxi-smaak',
    qwenVoiceRoy: 'Humoristische en directe Taiwanese jongen',
    qwenVoicePeter: 'Tianjin crosstalk professionele supporter',
    qwenVoiceSunny: 'Lief Sichuan-meisje',
    qwenVoiceEric: 'Chengdu-heer',
    qwenVoiceRocky: 'Humoristische Hongkong-jongen',
    qwenVoiceKiki: 'Lieve Hongkong-vriendin',
    // ASR Language names (native forms - autoglossonyms)
    ...
    lang_cy: 'Cymraeg',
    // BCP-47 format language codes (for Web Speech API)
    'lang_zh-CN': '中文 (vereenvoudigd, China)',
    'lang_zh-TW': '中文 (traditioneel, Taiwan)',
    'lang_zh-HK': '粵語 (Hongkong)',
    'lang_yue-Hant-HK': '粵語 (traditioneel)',
    'lang_en-US': 'English (Verenigde Staten)',
    'lang_en-GB': 'English (Verenigd Koninkrijk)',
    'lang_en-AU': 'English (Australië)',
    'lang_en-CA': 'English (Canada)',
    'lang_en-IN': 'English (India)',
    'lang_en-NZ': 'English (Nieuw-Zeeland)',
    'lang_en-ZA': 'English (Zuid-Afrika)',
    'lang_ja-JP': '日本語 (Japan)',
    'lang_ko-KR': '한국어 (Zuid-Korea)',
    'lang_de-DE': 'Deutsch (Duitsland)',
    'lang_fr-FR': 'Français (Frankrijk)',
    'lang_es-ES': 'Español (Spanje)',
    'lang_es-MX': 'Español (Mexico)',
    'lang_es-AR': 'Español (Argentinië)',
    'lang_es-CO': 'Español (Colombia)',
    'lang_it-IT': 'Italiano (Italië)',
    'lang_pt-BR': 'Português (Brazilië)',
    'lang_pt-PT': 'Português (Portugal)',
    'lang_ru-RU': 'Русский (Rusland)',
    'lang_nl-NL': 'Nederlands (Nederland)',
    'lang_pl-PL': 'Polski (Polen)',
    'lang_cs-CZ': 'Čeština (Tsjechië)',
    'lang_da-DK': 'Dansk (Denemarken)',
    'lang_fi-FI': 'Suomi (Finland)',
    'lang_sv-SE': 'Svenska (Zweden)',
    'lang_no-NO': 'Norsk (Noorwegen)',
    'lang_tr-TR': 'Türkçe (Turkije)',
    'lang_el-GR': 'Ελληνικά (Griekenland)',
    'lang_hu-HU': 'Magyar (Hongarije)',
    'lang_ro-RO': 'Română (Roemenië)',
    'lang_sk-SK': 'Slovenčina (Slowakije)',
    'lang_bg-BG': 'Български (Bulgarije)',
    'lang_hr-HR': 'Hrvatski (Kroatië)',
    'lang_ca-ES': 'Català (Spanje)',
    'lang_ar-SA': 'العربية (Saoedi-Arabië)',
    'lang_ar-EG': 'العربية (Egypte)',
    'lang_he-IL': 'עברית (Israël)',
    'lang_hi-IN': 'हिन्दी (India)',
    'lang_th-TH': 'ไทย (Thailand)',
    'lang_vi-VN': 'Tiếng Việt (Vietnam)',
    'lang_id-ID': 'Bahasa Indonesia (Indonesië)',
    'lang_ms-MY': 'Bahasa Melayu (Maleisië)',
    'lang_fil-PH': 'Filipino (Filipijnen)',
    'lang_af-ZA': 'Afrikaans (Zuid-Afrika)',
    'lang_uk-UA': 'Українська (Oekraïne)',
    // PDF settings
    pdfSettings: 'PDF-analyse',
    pdfParsingSettings: 'PDF-analyse-instellingen',
    pdfDescription:
      'Kies een PDF-analyse-engine met ondersteuning voor tekstextractie, beeldverwerking en tabelherkenning',
    pdfProvider: 'PDF-parser',
    pdfFeatures: 'Ondersteunde functies',
    pdfApiKey: 'API-sleutel',
    pdfBaseUrl: 'Base URL',
    mineruDescription:
      'MinerU is een commerciële PDF-analyseservice die geavanceerde functies ondersteunt zoals tabelextractie, formuleherkenning en lay-outanalyse.',
    mineruApiKeyRequired: 'Je hebt een API-sleutel nodig van de MinerU-website voordat je begint.',
    mineruWarning: 'Let op',
    mineruCostWarning:
      'MinerU is een commerciële service en kan kosten met zich meebrengen. Raadpleeg de MinerU-website voor prijsinformatie.',
    enterMinerUApiKey: 'Voer MinerU API-sleutel in',
    mineruLocalDescription:
      'MinerU ondersteunt lokale implementatie met geavanceerde PDF-analyse (tabellen, formules, lay-outanalyse). Vereist eerst het opzetten van de MinerU-service.',
    mineruServerAddress: 'Lokaal MinerU-serveradres (bijv. http://localhost:8080)',
    mineruApiKeyOptional: 'Alleen vereist als de server authenticatie heeft ingeschakeld',
    optionalApiKey: 'Optionele API-sleutel',
    featureText: 'Tekstextractie',
    featureImages: 'Beeldextractie',
    featureTables: 'Tabelextractie',
    featureFormulas: 'Formuleherkenning',
    featureLayoutAnalysis: 'Lay-outanalyse',
    featureMetadata: 'Metadata',
    // Image Generation settings
    enableImageGeneration: 'AI-beeldgeneratie inschakelen',
    imageGenerationDisabledHint:
      'Indien ingeschakeld worden afbeeldingen automatisch gegenereerd bij het aanmaken van lessen',
    imageSettings: 'Beeldgeneratie',
    imageSection: 'Tekst naar afbeelding',
    imageProvider: 'Beeldgeneratieprovider',
    imageModel: 'Beeldgeneratiemodel',
    providerSeedream: 'Seedream (ByteDance)',
    providerQwenImage: 'Qwen Image (Alibaba)',
    providerNanoBanana: 'Nano Banana (Gemini)',
    providerGrokImage: 'Grok Image (xAI)',
    testImageGeneration: 'Beeldgeneratie testen',
    testImageConnectivity: 'Verbinding testen',
    imageConnectivitySuccess: 'Verbinding met beeldservice geslaagd',
    imageConnectivityFailed: 'Verbinding met beeldservice mislukt',
    imageTestSuccess: 'Beeldgeneratietest geslaagd',
    imageTestFailed: 'Beeldgeneratietest mislukt',
    imageTestPromptPlaceholder: 'Voer beeldbeschrijving in om te testen',
    imageTestPromptDefault: 'Een schattige kat zittend op een bureau',
    imageGenerating: 'Afbeelding genereren...',
    imageGenerationFailed: 'Beeldgeneratie mislukt',
    // Video Generation settings
    enableVideoGeneration: 'AI-videogeneratie inschakelen',
    videoGenerationDisabledHint:
      'Indien ingeschakeld worden video\'s automatisch gegenereerd bij het aanmaken van lessen',
    videoSettings: 'Videogeneratie',
    videoSection: 'Tekst naar video',
    videoProvider: 'Videogeneratieprovider',
    videoModel: 'Videogeneratiemodel',
    providerSeedance: 'Seedance (ByteDance)',
    providerKling: 'Kling (Kuaishou)',
    providerVeo: 'Veo (Google)',
    providerSora: 'Sora (OpenAI)',
    providerGrokVideo: 'Grok Video (xAI)',
    testVideoGeneration: 'Videogeneratie testen',
    testVideoConnectivity: 'Verbinding testen',
    videoConnectivitySuccess: 'Verbinding met videoservice geslaagd',
    videoConnectivityFailed: 'Verbinding met videoservice mislukt',
    testingConnection: 'Testen...',
    videoTestSuccess: 'Videogeneratietest geslaagd',
    videoTestFailed: 'Videogeneratietest mislukt',
    videoTestPromptDefault: 'Een schattige kat die over een bureau loopt',
    videoGenerating: 'Video genereren (geschatte tijd 1-2 min)...',
    videoGenerationWarning: 'Videogeneratie duurt meestal 1-2 minuten, even geduld',
    mediaRetry: 'Opnieuw proberen',
    mediaContentSensitive: 'Sorry, deze inhoud heeft een veiligheidscontrole geactiveerd.',
    mediaGenerationDisabled: 'Generatie uitgeschakeld in instellingen',
    // Agent settings (kept with main settings block above)
    singleAgent: 'Enkelvoudige agent',
    multiAgent: 'Multi-agent',
    selectAgents: 'Agents selecteren',
    noVisionWarning:
      'Huidig model ondersteunt geen visie. Afbeeldingen kunnen nog steeds in dia\'s worden geplaatst, maar het model kan beeldinhoud niet begrijpen om selectie en lay-out te optimaliseren',
    // Server provider configuration
    serverConfigured: 'Server',
    serverConfiguredNotice:
      'De beheerder heeft een API-sleutel geconfigureerd voor deze provider op de server. Je kunt deze direct gebruiken of je eigen sleutel invoeren om te overschrijven.',
    optionalOverride: 'Optioneel — laat leeg om serverconfiguratie te gebruiken',
    // Access code
    setupNeeded: 'Configuratie vereist',
    modelNotConfigured: 'Selecteer een model om aan de slag te gaan',
    // Clear cache
    dangerZone: 'Gevarenzone',
    clearCache: 'Lokale cache wissen',
    clearCacheDescription:
      'Verwijder alle lokaal opgeslagen gegevens, inclusief lesrecords, chatgeschiedenis, audiocache en app-instellingen. Deze actie kan niet ongedaan worden gemaakt.',
    clearCacheConfirmTitle: 'Weet je zeker dat je alle cache wilt wissen?',
    clearCacheConfirmDescription:
      'Dit verwijdert permanent alle volgende gegevens en kan niet worden hersteld:',
    clearCacheConfirmItems:
      'Lessen en scènes, Chatgeschiedenis, Audio- en afbeeldingscache, App-instellingen en voorkeuren',
    clearCacheConfirmInput: 'Typ "VERWIJDEREN" om door te gaan',
    clearCacheConfirmPhrase: 'VERWIJDEREN',
    clearCacheButton: 'Alle gegevens permanent verwijderen',
    clearCacheSuccess: 'Cache gewist, pagina wordt binnenkort vernieuwd',
    clearCacheFailed: 'Cache wissen mislukt, probeer het opnieuw',
    // Web Search settings
    webSearchSettings: 'Zoeken op internet',
    webSearchApiKey: 'Tavily API-sleutel',
    webSearchApiKeyPlaceholder: 'Voer je Tavily API-sleutel in',
    webSearchApiKeyPlaceholderServer: 'Serversleutel geconfigureerd, optioneel overschrijven',
    webSearchApiKeyHint: 'Verkrijg een API-sleutel van tavily.com voor zoeken op internet',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: 'Server-side Tavily API-sleutel is geconfigureerd',
    optional: 'Optioneel',
  },
  profile: {
    title: 'Profiel',
    ...
    uploadAvatar: 'Uploaden',
    bioPlaceholder: 'Vertel iets over jezelf — de AI-docent past de lessen aan op jouw profiel...',
    avatarHint: 'Je avatar verschijnt in klasdiscussies en chats',
    fileTooLarge: 'Afbeelding te groot — kies er een kleiner dan 5 MB',
    invalidFileType: 'Selecteer een afbeeldingsbestand',
    editTooltip: 'Klik om profiel te bewerken',
  },
  media: {
    imageCapability: 'Beeldgeneratie',
    imageHint: 'Afbeeldingen genereren in dia\'s',
    videoCapability: 'Videogeneratie',
    videoHint: 'Video\'s genereren in dia\'s',
    ttsCapability: 'Spraaksynthese',
    ttsHint: 'AI-docent spreekt hardop',
    asrCapability: 'Spraakherkenning',
    asrHint: 'Spraakinvoer voor discussie',
    provider: 'Provider',
    model: 'Model',
    voice: 'Stem',
    speed: 'Snelheid',
